...
void main(void){
    ...
    while(1){
        ...
        if (device_mode == 0){
            ...
            if(PORTBbits.RB0 == 0 && ok==1 && alarm_status==0){
                pos--;
                if(pos < 8)
                    pos = 11;
                while(ok == 1){
            ...
            if(PORTBbits.RB2 == 0 && ok==1 && alarm_status==0){
                pos++;
                if(pos > 11)
                    pos = 8;
                while(ok == 1){
            ...
            if(PORTBbits.RB3 ==0 && ok == 1 && alarm_status == 0){
                alarm_digit[(pos - 8)]++;
                ...
                while(ok == 1)
                    if(PORTBbits.RB3 == 1) ok = 0;
            }
            if(PORTBbits.RB4 == 0 && ok==1 && alarm_status == 0){
